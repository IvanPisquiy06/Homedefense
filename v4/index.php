...
<head>
    ...
    <title>Home Defense</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <!-- meta content for search -->
    <link rel="icon" type="image/png" href="/assets/images/icono1.png">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="logo text-center">
                                    <div class="heading-survey">
                                        <div class="logo">
                                            <h1>
                                                <img src="/assets/images/logo1.png" alt="Home Defense" title="Home Defense">
                                            </h1>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form id="msform" class="form">
                                ...
                                <fieldset id="form-step7" class="form-steps fieldset-6" data-step="7" style="display: none;" data-tag="address">
                                    ...
                                    <div class="form-group" id="street_address">
                                        ...
                                        <div id="address_error" class="form-error-message">Por favor, ingrese una dirección.</div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-btns ml-auto text-right btn-last-submit">
                                                <button id="continue" type="submit" class="btn form-btn btn-next" onclick="showPopup()">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
